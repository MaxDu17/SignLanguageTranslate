...
class Prep(): #we use a lot of global variables to make thins more universal
    ...
    def unzip_pickle(self): #THIS IS THE EXTRACTION PROGRAM. ONLY CALL ME ONCE!!!
        ...
        try:
            self.big_list = self.unpickle("../LINKED/Storage/Data/BIG/BASIC_SignLanguageData.pkl")
        except:
        ...
        #random.shuffle(self.big_list) #this ensures a different test set and stuff
